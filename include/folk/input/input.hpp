...
public:
    ...
    /**
     * @returns @ref keystate_release if no keys are pressed,
     *          @ref keystate_press if at least one key is pressed,
     *          @ref keystate_repeat if at least one key has repeated.
    */
    KeyState state();
};
