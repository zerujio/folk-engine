#ifndef SRC_RENDER__GL_TEXTURE_HPP
#define SRC_RENDER__GL_TEXTURE_HPP
...
class Texture : public BaseHandle<isTexture> {
...
using TextureManager = ObjectManager<Texture, genTextures, deleteTextures>;

} // namespace Folk::gl


#endif //SRC_RENDER__GL_TEXTURE_HPP
